...
document.addEventListener("DOMContentLoaded", function () {
  var calendar = null;
  var calendarEl = document.getElementById("wp-zoom-calendar");

  if (!calendarEl) {
    return;
  }

  var args = JSON.parse(calendarEl.getAttribute("data-args"));
  var calendarOpts = {
    height: 'auto',
